package cn.bcd.server.simulator.singleVehicle.tcp.gb32960;
...
import cn.bcd.server.simulator.singleVehicle.tcp.HttpServerBuilder;
import cn.bcd.server.simulator.singleVehicle.tcp.WsInMsg;
...
public class HttpServerBuilder_gb32960 implements HttpServerBuilder {
    ...
    public void build(PathHandler pathHandler) {
        try (ResourceManager resourceManager = new ClassPathResourceManager(HttpServer.class.getClassLoader(), "server/simulator/singleVehicle/tcp/gb32960")) {
