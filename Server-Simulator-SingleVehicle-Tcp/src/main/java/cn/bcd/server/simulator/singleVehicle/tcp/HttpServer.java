...
import cn.bcd.server.simulator.singleVehicle.tcp.gb32960.HttpServerBuilder_gb32960;
...
public class HttpServer implements Runnable {
    ...
    @Override
    public void run() {
        try (ResourceManager resourceManager = new ClassPathResourceManager(HttpServer.class.getClassLoader(), "server/simulator/singleVehicle/tcp/common")) {
