package cn.bcd.server.business.process.backend.base.support_swagger;
...
public class SwaggerApiScanner {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        try (final OutputStream os1 = Files.newOutputStream(Paths.get("d://msbf1.xlsx"));
            ...
            scanApiAndExport(os1, null, 1, "cn.bcd.business.backend");
            scanApiAndExport(os2, null, 2, "cn.bcd.business.backend");
        }
    }
}
