package cn.bcd.server.business.backend.process.sys.controller;

import cn.bcd.server.business.backend.process.base.condition.Condition;
import cn.bcd.server.business.backend.process.base.condition.impl.DateCondition;
import cn.bcd.server.business.backend.process.base.condition.impl.NumberCondition;
import cn.bcd.server.business.backend.process.base.condition.impl.StringCondition;
import cn.bcd.server.business.backend.process.base.controller.BaseController;
import cn.bcd.server.business.backend.process.base.result.Result;
import cn.bcd.server.business.backend.process.base.support_satoken.SaTokenUtil;
import cn.bcd.server.business.backend.process.base.support_satoken.anno.NotePermission;
import cn.bcd.server.business.backend.process.base.support_satoken.anno.SaCheckNotePermissions;
