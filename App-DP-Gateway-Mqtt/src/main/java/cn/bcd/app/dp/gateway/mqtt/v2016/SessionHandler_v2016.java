package cn.bcd.app.dp.gateway.mqtt.v2016;

import cn.bcd.app.dp.gateway.mqtt.GatewayProp;
import cn.bcd.app.dp.gateway.mqtt.VehicleConsumeExecutorGroup;
...
@Order(10)
@Component
public class SessionHandler_v2016 implements DataHandler_v2016 {

    static Logger logger = LoggerFactory.getLogger(SessionHandler_v2016.class);
    ...
    @Override
    public void init(String vin, Context_v2016 context) throws Exception {
