package cn.bcd.business.backend.base.support_redis.schedule.aop;

import cn.bcd.base.exception.BaseException;
import cn.bcd.business.backend.base.support_redis.schedule.anno.SingleFailedSchedule;
import cn.bcd.business.backend.base.support_redis.schedule.handler.SingleFailedScheduleHandler;
...
public class RedisScheduleAopConfig {
     ...
     * 定时任务
     */
    @Pointcut("@annotation(cn.bcd.business.backend.base.support_redis.schedule.anno.SingleFailedSchedule)")
